execute as @a[scores={sleep=1}] run tellraw @a [{"selector":"@s","color":"dark_red","bold":true},{"text":" śpi. ","color":"dark_green","bold":true},{"text":"Kliknij tekst, jeżeli chcesz zostawić noc.","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/function whitepack:sleep/kickbed"},"hoverEvent":{"action":"show_text","value":{"text":"NOC!!!","color":"red"}}}]
